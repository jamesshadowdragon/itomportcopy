...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'LOGICNEST', subtitle: 'immersive digital builds' },
    { id: 'journey', position: [0, 0, -55], type: 'journey', title: 'BUILD', subtitle: 'React • UI • Motion • 3D' },
    { id: 'skills', position: [0, 0, -95], type: 'skills', title: 'STACK', subtitle: 'Design systems • Web apps • Launch-ready' },
    { id: 'impact', position: [0, 0, -135], type: 'impact', title: 'VISION', subtitle: 'Bold digital products that convert' },
];
